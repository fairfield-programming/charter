    ...
    >
      ...
      <section className='p-4 w-full grid grid-cols-3 gap-4'>
        ...
        <Link className='border rounded-xl p-4' href="#">
          ...
          <p className='text-sm'>One of the aspects of teaching kids is having a place for learning. Through our system, we find you a perfect school and give you resources on how to set up a partnership.</p>
        </Link>
        <Link className='border rounded-xl p-4' href="#">
          <h2 className='text-xl font-bold'>Find a Library</h2>
          <p className='text-sm'>Instead of working at a school, many charters opt-in to teaching public classes at a library. Through this program, we set you up in minutes with a library.</p>
        </Link>
        <Link className='border rounded-xl p-4' href="#">
          <h2 className='text-xl font-bold'>Host a Competition</h2>
          <p className='text-sm'>This button will take you to our competition hosting system, where we will show you how to get ready for a competition and the steps you should take to make it perfect.</p>
        </Link>
      </section>
  </Layout>
}
